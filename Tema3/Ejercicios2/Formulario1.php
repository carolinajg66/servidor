...
<form ACTION="<?=$_SERVER ['PHP_SELF'] //el archivo actual?>"
	...
	Nombre: <input TYPE="text" NAME="nombre"><br> Edad: <input TYPE="text"
		NAME="edad"><br> Email: <input TYPE="text" NAME="email"><br> <input
		TYPE="submit" name="bAceptar" VALUE="aceptar">
</form>
</body>
</html>
<?php
...
<form ACTION="<?=$_SERVER ['PHP_SELF'] //el archivo actual?>"
	METHOD='post'>
	<?php
        echo "Los datos que has introducido no estan en el formato correcto, los fallos que tienes son:<br>";
