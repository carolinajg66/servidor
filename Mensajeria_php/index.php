...
<div class="container">
  ...
  <form class="form-horizontal" action="registrar-usuario.php" method="post">
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" maxlength="20" placeholder="Ingresa tu nombre" name="username" required>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="user">Usuario:</label>
      <div class="col-sm-10">
        <input type="email" class="form-control" maxlength="50" id="email" placeholder="Ingresa el usuario" name="user">
      </div>
    </div>
    <div class="form-group">
